...
export default function Savedshows() {
  ...
  return (
    <div>
      <h2 className="text-sky-400 text-center uppercase text-lg underline font-bold md:text-xl p-4">My Shows</h2>
          ...
          {movies.map((item, id) => (
            <div className="w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2">
              ...
              <div className="absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white">
                ...
                <p onClick={() => deleteShow(item.id)} className="absolute text-tray-300 top-4 right-4"><AiOutlineClose /></p>
              </div>
            </div>
          ))}
        </div>
